...
const MetricHelper_1 = __importDefault(require("../../src/helper/MetricHelper"));
const MockDate = __importStar(require("mockdate"));
describe('Test Metric Helper', () => {
    let inputEvents;
    let outputEvents;
    const metricHelper = new MetricHelper_1.default();
    beforeEach(() => {
        inputEvents = [{
    ...
    it('Should filter last 24 hours events only', () => {
        const filteredEvents = metricHelper.filterLast24HourEvents(inputEvents);
